...
//	return $http.get('../goods/updateAuditStatus/'+auditStatus+"/"+ids);
	
	/**
	 * 修改商品的审核状态
	 * @return
	 */
	@RequestMapping("/updateAuditStatus/{auditStatus}/{ids}")
	public Result updateAuditStatus(@PathVariable("auditStatus") String auditStatus,@PathVariable("ids") Long[] ids){
		try {
			goodsService.updateAuditStatus(auditStatus,ids);
